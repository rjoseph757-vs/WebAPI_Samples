...
namespace AuthorizationServer8.Controllers
{
    ...
    [ApiController]
    public class xAuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] xRegistrationModel model)
        {
        ...
        [HttpPost("Login")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(xLoginResponse))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Login([FromBody] xLoginModel model)
        {
        ...
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Refresh([FromBody] xRefreshModel model)
        {
